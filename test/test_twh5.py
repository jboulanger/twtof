...
def test_print_content(test_file, capsys):
...
class TestTofH5Reader:
    def test_context_manager(self, test_file):
        """Test the TofH5Reader as a context manager."""
        with twtof.TofH5Reader(test_file) as f:
            assert f.file is not None
            assert isinstance(f.file, twtof.h5py.File)
        assert f.file is None

    def test_open_close(self, test_file):
    ...
    def test_load_acquisition_log(self, test_file):
    ...
    def test_load_fib_image(self, test_file):
    ...
    def test_load_fib_pressure(self, test_file):
    ...
    def test_load_peak_data(self, test_file):
    ...
    def test_load_peak_table(self, test_file):
